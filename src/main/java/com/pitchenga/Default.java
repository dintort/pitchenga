...
public class Default {
    ...
    public static final PitchProcessor.PitchEstimationAlgorithm DEFAULT_PITCH_ALGO = PitchProcessor.PitchEstimationAlgorithm.MPM; //fixme: Neither of them work for bass guitar. MPM does not seem to work below mi2.
...
//    public static final Pitchenga.Hinter DEFAULT_HINTER = Pitchenga.Hinter.Never;
