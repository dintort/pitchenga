...
public class Default {
    ...
    public static final int DEFAULT_PENALTY_FACTOR = 0;
    public static final Integer[] DEFAULT_OCTAVES = new Integer[]{2, 3, 4, 5, 6};
    public static final PitchProcessor.PitchEstimationAlgorithm DEFAULT_PITCH_ALGO = PitchProcessor.PitchEstimationAlgorithm.MPM;

//    public static final Pitchenga.Hinter DEFAULT_HINTER = Pitchenga.Hinter.OneSec;
//    public static final Pitchenga.Hinter DEFAULT_HINTER = Pitchenga.Hinter.Delayed;
//    public static final Pitchenga.Hinter DEFAULT_HINTER = Pitchenga.Hinter.Always;
    public static final Pitchenga.Hinter DEFAULT_HINTER = Pitchenga.Hinter.Delayed100;
...
//    public static final Pitchenga.Pacer DEFAULT_PACER = Pitchenga.Pacer.Tempo50;

    public static final Pitchenga.Riddler DEFAULT_RIDDLER = Pitchenga.Riddler.Diatonic;
//    public static final Pitchenga.Riddler DEFAULT_RIDDLER = Pitchenga.Riddler.ChromaticWithDoubledDiatonic;
//    public static final Pitchenga.Riddler DEFAULT_RIDDLER = Pitchenga.Riddler.Chromatic;
//    public static final Pitchenga.Riddler DEFAULT_RIDDLER = Pitchenga.Riddler.ChromaticOneOctave;
//    public static final Pitchenga.Riddler DEFAULT_RIDDLER = Pitchenga.Riddler.ChromaticWithDoubledSharps;
//    public static final Pitchenga.Riddler DEFAULT_RIDDLER = Pitchenga.Riddler.ChromaticScaleUpDown;
...
//    public static final Pitchenga.GuessRinger DEFAULT_GUESS_RINGER = Pitchenga.GuessRinger.ToneAndDo;
...
//    public static final Pitchenga.RiddleRinger DEFAULT_RIDDLE_RINGER = Pitchenga.RiddleRinger.Tone;
    ...
    public static final Mixer.Info DEFAULT_AUDIO_INPUT = NO_AUDIO_INPUT;
