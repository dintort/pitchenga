...
//        case KeyEvent.VK_QUOTE:        handleKey(Pitch.Fa4, pressed);
    ...
    n03(Pitch.lU3, KeyEvent.VK_3, "3", true),
    n04(Pitch.La3, KeyEvent.VK_4, "4", true),
    n05(Pitch.tO3, KeyEvent.VK_5, "5", true),
    ...
    m03(Pitch.lU3, -3, null, false),
    m04(Pitch.La3, -4, null, false),
    m05(Pitch.tO3, -5, null, false),
    ...
    Y(Pitch.lU3, KeyEvent.VK_Y, "y", false),
    H(Pitch.La3, KeyEvent.VK_H, "h", false),
    U(Pitch.tO3, KeyEvent.VK_U, "u", false),
