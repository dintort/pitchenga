...
//    m07(null, -7, null, false),
    ...
    I(null, KeyEvent.VK_I, 1, null, false),
    K(Do5, KeyEvent.VK_K, 2, "k", false),
    O(Ra5, KeyEvent.VK_O, 1, "o", false),
    L(Re5, KeyEvent.VK_L, 2, "l", false),
    P(Me5, KeyEvent.VK_P, 1, "p", false),
    SEMICOLON(Mi5, KeyEvent.VK_SEMICOLON, 2, ";", false),
    QUOTE(Fa5, KeyEvent.VK_QUOTE, 2, "\"", false),
    OPEN_BRACKET(null, KeyEvent.VK_OPEN_BRACKET, 1, null, false),
    CLOSE_BRACKET(Fi5, KeyEvent.VK_CLOSE_BRACKET, -1, null, false),
//    OPEN_BRACKET(Fi4, KeyEvent.VK_OPEN_BRACKET, null, false),
//    OPEN_BRACKET(Fi5, KeyEvent.VK_CLOSE_BRACKET, 1, null),
    BACK_SLASH(So5, KeyEvent.VK_BACK_SLASH, -1, null, false),
    ;
