...
//    public static final Pitchenga.Riddler DEFAULT_RIDDLER = Pitchenga.Riddler.ChromaticWithTripledFiLe;
...
//    public static final Pitchenga.RiddleRinger DEFAULT_RIDDLE_RINGER = Pitchenga.RiddleRinger.Tone;
    ...
    public static final Mixer.Info DEFAULT_INPUT = NO_AUDIO_INPUT; //Disabled by default, because otherwise the game plays with itself through the microphone which is confusing - will probably remove when fixed it.
//    public static final Mixer.Info DEFAULT_INPUT = null;
}
